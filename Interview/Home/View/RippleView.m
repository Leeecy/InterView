...
- (void)addAnimationLayer {
    ...
    _rippleLayer1.borderColor = self.rippleColor?self.rippleColor.CGColor:ColorWithAlpha(34, 34, 40, 0.5).CGColor;
    ...
    _rippleLayer2.borderColor = self.rippleColor?self.rippleColor.CGColor:ColorWithAlpha(34, 34, 87, 0.5).CGColor;
    ...
    _rippleLayer3.borderColor = self.rippleColor?self.rippleColor.CGColor:ColorWithAlpha(34, 34, 40, 0.5).CGColor;
...
- (CABasicAnimation *)scaleAnimate{
    ...
    scaleAnimate.toValue = self.scaleTimes?@(self.scaleTimes):@(4.0);
    return scaleAnimate;
}
...
- (CAKeyframeAnimation *)gradualAnimate{
    ...
    animate.values = @[(__bridge id) [self.rippleColor colorWithAlphaComponent:0.5].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0.5].CGColor : (__bridge id)ColorWithAlpha(23, 23, 30, 0.5).CGColor,
                       (__bridge id) [self.rippleColor colorWithAlphaComponent:0.4].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0.4].CGColor : (__bridge id)ColorWithAlpha(34,34,40,0.4).CGColor,
                       (__bridge id) [self.rippleColor colorWithAlphaComponent:0.2].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0.2].CGColor : (__bridge id)ColorWithAlpha(34, 34, 40, 0.2).CGColor,
                       (__bridge id) [self.rippleColor colorWithAlphaComponent:0].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0].CGColor : (__bridge id)ColorWithAlpha(23, 23, 30, 0).CGColor
                       ];
...
- (CAKeyframeAnimation *)borderColorAnimate{
    ...
    animate.values = @[(__bridge id) [self.rippleColor colorWithAlphaComponent:0.5].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0.5].CGColor : (__bridge id)ColorWithAlpha(23, 24, 30, 0.5).CGColor,
                       (__bridge id) [self.rippleColor colorWithAlphaComponent:0.4].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0.4].CGColor : (__bridge id)ColorWithAlpha(34, 34, 40,0.4).CGColor,
                       (__bridge id) [self.rippleColor colorWithAlphaComponent:0.2].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0.2].CGColor : (__bridge id)ColorWithAlpha(34, 34, 40, 0.2).CGColor,
                       (__bridge id) [self.rippleColor colorWithAlphaComponent:0].CGColor ? (__bridge id) [self.rippleColor colorWithAlphaComponent:0].CGColor : (__bridge id)ColorWithAlpha(34, 34, 40, 0).CGColor
                       ];
    animate.keyTimes = @[@0.3,@0.6,@0.9,@1];
    return animate;
}
