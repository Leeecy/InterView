...
// default
// 超过多少毫秒为一次卡顿
static const NSInteger MXRMonitorRunloopOneStandstillMillisecond = 500;
// 多少次卡顿纪录为一次有效卡顿
...
@end
@implementation CLMonitorRunloop
+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    static CLMonitorRunloop *cls;
...
static void runLoopObserverCallBack(CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *info){
    ...
    CLMonitorRunloop *instance = [CLMonitorRunloop sharedInstance];
    // 记录状态值
...
-(void)registerObserver{
    ...
    CFRunLoopObserverContext contex = {0, (__bridge void *)self, NULL, NULL};
    ...
    _observer = CFRunLoopObserverCreate(kCFAllocatorDefault, kCFRunLoopAllActivities, YES, 0, &runLoopObserverCallBack, &contex);
